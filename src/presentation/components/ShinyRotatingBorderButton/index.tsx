...
export const ShinyRotatingBorderButton = ({
    ...
    return (
        <button
            className={cn(
                "group relative overflow-hidden rounded-full bg-transparent neutral-200 p-px transition-transform h-[35px] mx-8 active:scale-95 dark:bg-neutral-600",
                className
            )}
            type="button"
            {...props}
        >
            ...
            <span className="relative z-10 block rounded-full h-auto bg-slate-50 px-3 py-1 dark:bg-neutral-800">
                <motion.span
                    animate={{
                        backgroundImage: [
